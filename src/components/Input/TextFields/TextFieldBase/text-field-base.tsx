...
import type { FieldValidator } from '@patterns/Forms/form-context';
import { useAriaId, useTheme, useScreenSize, useIsomorphicLayoutEffect } from '@hooks/hooks';
import { Text3 } from '@components/Text';
import type { InputState } from '@components/Input/TextFields/TextFieldComponent/text-field-components';
import { Label, HelperText, FieldContainer } from '@components/Input/TextFields/TextFieldComponent/text-field-components';
import { LABEL_LEFT_POSITION, LABEL_SCALE_MOBILE, LABEL_SCALE_DESKTOP } from '@components/Input/TextFields/TextFieldComponent/text-field-components.css';
