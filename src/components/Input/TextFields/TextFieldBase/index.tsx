...
import type { InputState } from '@components/Input/TextFields/TextFieldComponent';
import { Label, HelperText, FieldContainer } from '@components/Input/TextFields/TextFieldComponent';
import { LABEL_LEFT_POSITION, LABEL_SCALE_MOBILE, LABEL_SCALE_DESKTOP } from '@components/Input/TextFields/TextFieldComponent/index.css';
